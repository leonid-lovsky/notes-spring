...
> Последнее обновление: 2026-06-19T11:44Z
...
- **Начало каждой сессии** — прочитать этот файл свежим взглядом; рассмотреть адаптеры / архитектурные вопросы / вопросы реализации; обновить при наличии улучшений → коммит и пуш
