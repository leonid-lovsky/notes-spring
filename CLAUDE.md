...
3. Рассмотреть адаптеры / архитектурные вопросы / вопросы реализации
4. Обновить: актуализировать, убрать избыточность, улучшить формулировки, провести рефакторинг
5. Сделать коммит и пуш _(постоянная авторизация — явный запрос не нужен)_
