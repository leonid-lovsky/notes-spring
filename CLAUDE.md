...
> Последнее обновление: 2026-06-23T18:58Z
...
- **Формулировки** — пользователь делегирует формулировку мыслей ассистенту; входящий текст может быть кратким и неточным — переформулировать чётко и грамотно при записи в этот файл
...
- **Запоминать в этот файл**: любое правило, договорённость или решение фиксируется в CLAUDE.md — не только в локальной памяти; локальная память недоступна другим пользователям и другим машинам
