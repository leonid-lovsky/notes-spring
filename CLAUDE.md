...
> Последнее обновление: 2026-06-24T10:19Z
...
> Convention plugins созданы для всех технологий. `✓` — реализован; `пуст` — build.gradle есть, исходников нет; `—` — не создан.

| Адаптер                 | Тип     | `user/` | `note/` | `user-note/` |
|-------------------------|---------|---------|---------|--------------|
| `data-jpa`              | driven  | ✓       | ✓       | ✓            |
| `data-mongodb`          | driven  | ✓       | ✓       | ✓            |
| `data-jdbc`             | driven  | —       | пуст    | —            |
| `data-r2dbc`            | driven  | —       | пуст    | —            |
| `data-mongodb-reactive` | driven  | —       | пуст    | —            |
| `webmvc`                | driving | ✓       | ✓       | ✓            |
| `webflux`               | driving | —       | —       | —            |
| `graphql`               | driving | —       | —       | —            |
