...
- `docs/decisions-log.md` — [REVIEW] — новый 2026-07-23, вынесен из CLAUDE.md → «Принятые решения» (снятие объёма, AI-readability); 2026-09-25 сюда же дословно перенесена хронология переписывания из CLAUDE.md → «Задачи»
