...
### docs/ (16 файлов, перенесены из корня 2026-07-24 — реструктуризация документации под 100%-доступность для ИИ-агента, см. CLAUDE.md → «Правила» → «Документация — только для ИИ-агента, не для человека»)
- `docs/db-migration-tools-reference.md` — [REVIEW]
- `docs/decisions-log.md` — [REVIEW] — новый 2026-07-23, вынесен из CLAUDE.md → «Принятые решения» (снятие объёма, AI-readability); 2026-09-25 сюда перенесена хронология переписывания из CLAUDE.md → «Задачи», весь файл сокращён 143k → 29k без потери решений
