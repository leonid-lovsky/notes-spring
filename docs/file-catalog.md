...
- `docs/user-note-access-model.md` — [REVIEW] — новый 2026-09-25, модель доступа `UserNote` (права на заметку, роли-шаблоны для UI, инварианты, хранение SQL/NoSQL, JWT/Spring Security, механизмы инвариантов по слоям UI/Framework/Model/Storage) — ход обсуждения и точка остановки, не решение, по прямому запросу пользователя
