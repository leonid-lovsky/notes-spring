...
Пометка про статус `data-jpa` («в сборке сейчас нет») — сначала убрана по запросу пользователя 2026-09-22, затем в ту же сессию возвращена явным «верни замечание про jpa» — оставлять её в блоке.
