...
> **Назначение:** «дерево модулей» — все листовые Gradle-модули `user-note/` с пакетом и напрямую применёнными convention-плагинами
> **Когда читать:** при правке `build.gradle.kts` модулей, при запросе «дерево модулей» (выводить дословно)
> **Статус:** снимок; источник истины при расхождении — сами `build.gradle.kts` (команда сверки — ниже в файле)
