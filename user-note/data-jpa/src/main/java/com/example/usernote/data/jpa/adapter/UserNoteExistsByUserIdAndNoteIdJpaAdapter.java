...
@Repository
class UserNoteExistsByUserIdAndNoteIdJpaAdapter implements UserNoteExistsByUserIdAndNoteIdContract {

    private final UserNoteJpaRepository userNoteJpaRepository;

    UserNoteExistsByUserIdAndNoteIdJpaAdapter(UserNoteJpaRepository userNoteJpaRepository) {
